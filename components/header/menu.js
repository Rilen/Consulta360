...
function getMenuHtml(currentRoute) {
    ...
    <div class="flex items-center gap-4">
        ...
        ${
          ...
          : `<a href="#" data-route="home" class="flex items-center gap-2 text-sm font-medium text-slate-200 hover:text-white transition-colors">
        ...
        ${
          ...
          : `<a href="#" data-route="graficos" class="flex items-center gap-2 text-sm font-medium text-slate-200 hover:text-white transition-colors">
        ...
        ${
          ...
          : `<a href="#" data-route="auditoria" class="flex items-center gap-2 text-sm font-medium text-slate-200 hover:text-white transition-colors">
        ...
        ${
          ...
          : `<a href="#" data-route="evolucao" class="flex items-center gap-2 text-sm font-medium text-slate-200 hover:text-white transition-colors">
