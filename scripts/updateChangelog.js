...
// Remover badge de "Atual" da versão 0.0.4 e opacidade
...
content = content.replace('<!-- Versão V0.0.4 -->\n      <section class="ag-card rounded-2xl p-8 relative overflow-hidden group">', '<!-- Versão V0.0.4 -->\n      <section class="ag-card rounded-2xl p-8 relative overflow-hidden group opacity-80">');

const newVersionHtml = `      <!-- Versão V0.0.5 -->
      <section class="ag-card rounded-2xl p-8 relative overflow-hidden group">
        ...
        <div class="flex items-center justify-between border-b border-slate-100 pb-4 mb-5">
          <div class="flex items-center gap-3">
            <span class="px-3 py-1 bg-blue-100 text-blue-700 text-xs font-bold rounded-full tracking-wider">v0.0.5</span>
        ...
        <div class="space-y-6 relative z-10">
          <div>
            ...
            <ul class="list-disc list-inside text-sm text-slate-600 space-y-2 ml-1">
              <li><strong>Extrator TransparênciaBR:</strong> Robô independente (Puppeteer) criado para automatizar e blindar a coleta de dados, contornando a instabilidade da API.</li>
              <li><strong>Arquitetura Multi-Entidades:</strong> Motor de sincronização dinâmico suportando roteamento para diferentes domínios.</li>
              <li><strong>OstrasPrev:</strong> Inclusão do sistema previdenciário como fonte de dados nativa em todas as interfaces.</li>
            </ul>
          </div>
        </div>
      </section>
